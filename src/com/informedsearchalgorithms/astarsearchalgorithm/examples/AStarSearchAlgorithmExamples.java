package com.informedsearchalgorithms.astarsearchalgorithm.examples;
...
public class AStarSearchAlgorithmExamples {
...
public static void displayExamples(){
        ...
        HeuristicWeightedNode h = new HeuristicWeightedNode("H", new Integer[]{101}, 98);
        ...
        textArea.setText(AStarSearchAlgorithm.search(a,  "I"));
     ...
     // Problem # 2
        ...
        // Display Result in Dialogue Box
        textArea.setText(AStarSearchAlgorithm.search(s,  "g"));
